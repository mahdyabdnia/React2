...
<ImageBackground source={require('../images/back.jpg')}style={{ width: '100%', height: null, flex: 1 }} >
            <View style={{flex:1,marginLeft:10,flexDirection:'column'}}>
                       ...
                       <View style={{flex:1}}></View>
                        ...
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('Second')} style={{flex:4,borderRadius:10,alignItems:"center",backgroundColor:'#909aab',marginRight:12,marginLeft:2,justifyContent:'space-evenly'}} ><View style={{flex:0.5}}></View>
                            <Image style={{width:'50%',height:'50%',borderRadius:10}} source={require('../images/ba.jpg')}/>
                       <Text style={{color:'#ffffff',fontSize:30}}>ضرب المثل ها </Text>
                        </TouchableOpacity>
                ...
                <View style={{flex:4,flexDirection:'row'}}>
                   ...
                   <TouchableOpacity  onPress={()=>this.props.navigation.navigate('Third')}  style={{backgroundColor:'#3f6196',borderRadius:10,flex:4,flexDirection:'column',alignItems:'center',justifyContent:'space-evenly'}} ><View style={{flex:0.5}}></View>
